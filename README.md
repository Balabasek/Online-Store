...
### Backend
* Backend чать будет написана на Java EE.
* Сборка проекта с помощью Maven v3.6.3.
* Проект будет запущен на сервере приложений Wildfly v20.0.
* База данных для хранения информации о пользователях и товаров MongoDB.
### Frontend
* TypeScript.
* JavaScript.
* SCSS.
* HTML.
### Система контроля версий Git, онлайн-сервис для размещения проекта GitLab.
